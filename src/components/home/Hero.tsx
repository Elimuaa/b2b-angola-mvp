        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-full text-xs font-medium text-gray-600 shadow-sm mb-8">
              ...
              Plataforma #1 de Serviços B2B em Angola
            </span>
          </motion.div>
          ...
          >
            Conecte-se com freelancers verificados e empresas de confiança.
            ...
            >
              <div className={`relative flex-1 flex items-center bg-white rounded-2xl border transition-all duration-300 ${
                ...
                <input
                  ...
                  className="w-full pl-13 pr-4 py-4 sm:px-5 bg-transparent text-base placeholder-gray-400 focus:outline-none rounded-2xl pl-14"
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span><strong className="text-gray-900">4.8</strong> Avaliação Média</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-gray-500">
